...
let numeroWhile = 0;
let massa = 0;
while (numeroWhile < starWarsCharacters.length) {
  massa = massa + parseInt(starWarsCharacters[numeroWhile].mass);
  numeroWhile++;
}
console.log(massa);
/* ESERCIZIO 7
...
for (let index = 0; index < characters.length; index++) {
  for (let index2 = 0; index2 < femaleCharacters.length; index2++) {
    if (characters[index] === femaleCharacters[index2].name) {
...
console.log("il tuo personaggio casuale è:", starWarsCharacters[rand]);
